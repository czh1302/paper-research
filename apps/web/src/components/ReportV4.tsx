...
function ThemeEvidenceCard({
  ...
  const keyPapers = theme.paper_ids
    ...
    .slice(0, 3);
  return <article className="v4-natural-card rounded-xl border border-line p-4">
