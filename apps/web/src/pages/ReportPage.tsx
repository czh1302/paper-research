...
export function ReportPage({ readOnly = false }: { readOnly?: boolean }) {
  ...
  if (!record) return <div className="panel p-12 text-center text-muted">{text("加载报告…", "Loading report…")}</div>;
